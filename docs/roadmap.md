...
| P2 | Expand the admin dashboard into a fuller operations console | Done | Adds operator summaries, searchable/filterable publication and license views, audit visibility, and clearer loading and empty states. |
